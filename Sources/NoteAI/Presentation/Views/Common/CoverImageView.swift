...
struct CoverImageView: View {
    ...
    init(
        imageData: Data?,
        size: CGSize,
        cornerRadius: CGFloat = AppConstants.UI.buttonCornerRadius,
...
extension CoverImageView {
    static func cardSize(imageData: Data?) -> CoverImageView {
        CoverImageView(
            imageData: imageData,
            size: CGSize(width: .infinity, height: AppConstants.Image.cardImageHeight),
    ...
    static func rowSize(imageData: Data?) -> CoverImageView {
        CoverImageView(
            imageData: imageData,
            size: AppConstants.Image.rowImageSize,
            cornerRadius: AppConstants.UI.buttonCornerRadius,
            placeholderIcon: "folder"
        )
    }
    ...
    static func thumbnailSize(imageData: Data?) -> CoverImageView {
        CoverImageView(
            imageData: imageData,
            size: AppConstants.Image.thumbnailSize,
